...
test("README and historical Task 5 report use their canonical live and CuTe DSL URLs", async () => {
  const [readme, report] = await Promise.all([
    readFile(new URL("../README.md", import.meta.url), "utf8"),
    readFile(new URL("../.superpowers/sdd/2026-08-29-gpu-kernel-atlas-curriculum-2026/task-5-report.md", import.meta.url), "utf8"),
  ]);
  ...
  tag(report, /https:\/\/docs\.nvidia\.com\/cutlass\/latest\/media\/docs\/pythonDSL\/cute_dsl\.html/);
  assert.doesNotMatch(report, /https:\/\/docs\.nvidia\.com\/cutlass\/latest\/media\/docs\/cpp\/cute_dsl\.html/);
});
