...
- 11 interactive learning atlases and the unchanged 12-week roadmap
...
The eleven laboratories are unified under one shared `main`/`h1` atlas frame.
Each laboratory keeps its specialist body with scoped CSS, plus verified
accessibility, responsive behavior, and overflow safeguards. The eleven-lab
