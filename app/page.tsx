...
const metadataCopy = {
  tr: {
    description: "CUDA, Triton, GPU belleği, kernel operatörleri, profilleme, çıkarım ve çoklu GPU sistemleri için birleşik 12 haftalık etkileşimli öğrenme atlası.",
