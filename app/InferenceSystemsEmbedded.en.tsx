...
const inferencePrecisions = {
  ...
  mxfp4: { label: "MXFP4", hardware: "Backend-specific Blackwell acceleration; verify the platform fallback dtype", backend: "Linear and MoE backends do not guarantee the same activation dtype", scaleRepresentation: "OCP MX FP4 E2M1 + E8M0 scale per 32-element block", accumulation: "Verify any high-precision accumulation choice with the selected backend documentation.", qualityGuardrail: "Educational guardrail: test ignored layers and the quality-loss boundary with task metrics.", sourceId: "vllm-online-quantization", sourceIds: ["vllm-online-quantization", "cutlass-inference-formats", "vllm-quantization-hardware"], maturity: "current" },
