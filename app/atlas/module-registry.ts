...
const maturityById: Record<ModuleId, Maturity> = {
  visual: "core", toolchain: "core", architecture: "current", memory: "current", triton: "current",
...
const trModules = [
  ...
  {
    id: "toolchain", index: "02", title: "Mühendislik Temelleri", short: "C++ · Linux · Git · CMake", phase: "Zemin",
  ...
  {
    id: "architecture", index: "03", title: "Mimari → SIMT → CUDA", short: "Izgara · Blok · Warp · Şerit", phase: "Zihinsel model",
  ...
  {
    id: "memory", index: "04", title: "GPU Bellek Laboratuvarı", short: "Birleşik erişim · Bankalar · Doluluk", phase: "Veri hareketi",
  ...
  {
    id: "operators", index: "06", title: "LLM Kernel Desenleri", short: "GEMM · İndirgeme · Softmax · Dikkat", phase: "Operatörler",
  ...
  {
    id: "correctness", index: "07", title: "Kernel Doğruluğu ve Güvenliği", short: "Referans · Tolerans · Doğrulama", phase: "Kanıt",
  ...
  {
    id: "profiling", index: "08", title: "Nsight ve Kıyaslama Rehberi", short: "Nsight Systems · Nsight Compute · Deney tasarımı", phase: "Ölçüm",
  ...
  {
    id: "cutlass", index: "09", title: "CUTLASS · CuTe · Tensor Core · PTX", short: "Soyutlamadan silikona", phase: "Derin optimizasyon",
  ...
  {
    id: "inference", index: "10", title: "Çıkarım Sistemleri Laboratuvarı", short: "vLLM · CUDA Graphs · Nicemleme", phase: "Sunum",
  ...
  {
    id: "multigpu", index: "11", title: "NCCL ve Çoklu GPU Sistemleri", short: "Kolektifler · Paralellik · RDMA", phase: "Dağıtık sistem",
  ...
  {
    id: "systems", index: "12", title: "GPU Yazılım Yığını", short: "ROCm/HIP · MLIR · TensorRT", phase: "Ekosistem",
...
const enModules = [
  {
    ...
    description: "Learn what a GPU is, what lives inside it, and how a kernel moves through its lifecycle with visual explanations, lasting-learning cards, common pitfalls, and a self-check.",
    concepts: ["CPU vs GPU", "GPU anatomy (SM, L2, HBM)", "Kernel lifecycle and lasting learning"],
    outcome: "Build a visual mental model of GPU concepts and durable mnemonics you can recall long after the course.", tags: ["GPU 101", "visual", "mnemonic", "quiz"], accent: "rose",
  },
  {
