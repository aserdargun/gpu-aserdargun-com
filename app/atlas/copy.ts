export const uiByLocale = {
  tr: {
    ...
    map: "ATLAS HARİTASI", mapA: "Tek uygulama.", mapB: "On bir uzmanlık alanı.", mapNote: "Temelden capstone’a ilerleyen rota. Her atlas kendi etkileşimli laboratuvarını, karar modelini ve kabul çıktısını içerir.", done: "TAMAMLANDI", completionStatus: "Tamamlandı",
  ...
  en: {
    ...
    map: "ATLAS MAP", mapA: "One application.", mapB: "Eleven domains.", mapNote: "A route from foundations to capstone. Every atlas includes an interactive lab, a decision model, and an acceptance artifact.", done: "COMPLETED", completionStatus: "Completed",
